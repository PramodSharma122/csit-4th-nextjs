...
export default function ToDoApp() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-[#e1b382] to-[#c89666] min-w-full">
      {/* Main container */}
      <div className="w-full max-w-4xl p-8 bg-[#12343b] rounded-xl shadow-[3px_6px_40px_#000] mt-8">
        {/* Title */}
        <h1 className="text-3xl font-bold mb-4 text-blue-200 text-center underline underline-offset-4">
          My ToDo List
        </h1>
        {/* Add Todo Input */}
        ...
        <ul className="space-y-2">
          {filteredTodos.map((todo) => (
            <li
              key={todo.id}
              className="flex text-gray-700 items-center justify-between bg-gray-100 px-4 py-2 rounded"
            >
              {/* Todo item */}
